    ...
    <div class="card-body">
      <div class="row justify-content-md-center">
        <div class="col-md-12">
            ...
            <div class="form-group row">
            <label for="category" class="col-sm-2 text-right col-form-label">Category <span class="text-danger">*</span></label>
              <div class="col-sm-5">
                  {{ Form::select('category_id', $categories, Null, ['class' => 'form-control', 'id' => 'category', 'placeholder' => 'Choose Category']) }}
              </div>
            </div>
